				...
				<td align="center" valign="middle" bgcolor="#18c197" style="-moz-border-radius: 8px 8px 0px 0px; border-radius: 8px 8px 0px 0px;"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0"class="two-left-inner">
					...
					<tr>
						...
						<table width="165" border="0" align="left" cellpadding="0" cellspacing="0" class="two-left-inner">
						    ...
						    <tr>
							<td style="font-family:'Open Sans', Verdana, Arial; font-size:18px; color:#FFF; font-weight:normal; line-height:30px;" mc:edit="nm20-02" align="center" valign="middle">Confirm your order</td>
						    </tr>
						</table>
	...
	<td align="center" valign="top"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
		<tr>
		    <td align="center" valign="middle" bgcolor="#FFFFFF" style="-moz-border-radius: 0px 0px 8px 8px; border-radius: 0px 0px 8px 8px;"><table width="490" border="0" cellspacing="0" cellpadding="0" class="two-left-inner">
			    ...
			    <tr>
				<td align="left" valign="top" style="font-family:'Open Sans', Verdana, Arial; font-size:30px; color:#121212; font-weight:normal;" mc:edit="nm20-04"><multiline>Hi, <?= Yii::$app->user->identity->first_name ? Yii::$app->user->identity->first_name . " " . Yii::$app->user->identity->first_name : Yii::$app->user->identity->username ?></multiline></td>
		</tr>
		<tr>
		    <td height="20" align="center" valign="middle" style="line-height:20px; font-size:20px;">&nbsp;</td>
		</tr>
		<tr>
		    <td align="left" valign="top" style="font-family:'Open Sans', Verdana, Arial; font-size:14px; color:#767676; font-weight:normal; line-height:28px;">
			<multiline>
			    Your order details:<br> 
			    Wallet number: <?= $model->wallet_number ?><br>
			    From: <?= $model->summ_out ?> <?= $model->currency->iso_code ?><br>
			    To: <?= (float) rtrim($model->summ_in, '0') ?> <?= $model->crypto->letter ?><br>
			</multiline>
		    </td>
		</tr>
		<tr>
		    <td align="left" valign="top" style="font-family:'Open Sans', Verdana, Arial; font-size:14px; color:#767676; font-weight:normal; line-height:28px;" mc:edit="nm20-05"><multiline>
		    <br>
		    Your confirmation code is: <strong><?= $code ?></strong><br> </multiline>
		<br><br>
